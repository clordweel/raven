            ...
            <SettingsContentContainer>
                ...
                <Stack gap='6' pt='2'>
                    <Stack className="max-w-[480px]">
                        <Box>
                            <Label htmlFor='EnterKeyBehaviour' isRequired>{__('When writing a message, press')} <strong>Enter</strong> {__('to:')}</Label>
                    ...
                    <Stack className="max-w-[480px]">
                        ...
                        <HelperText>
                            {__('Click on any button to set your favorite emoji for quick reactions. These emojis will be available as quick reactions in chat messages.')}
                        </HelperText>
                    </Stack>
                </Stack>
            </SettingsContentContainer>
