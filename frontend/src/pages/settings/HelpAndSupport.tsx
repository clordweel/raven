    ...
    return (
        <PageContainer>
            <SettingsContentContainer>
                <SettingsPageHeader
                    title={__('Help and Support')}
                />

                <Stack gap="5">
                    <Stack>
                        <Text color="gray" size="2" as='span' className='font-medium'>{__('Have ideas or ran into an issue?')}</Text>
                        <div>
                            <Button size="2" onClick={on} variant="outline"
                                color='gray'
                                className="not-cal cursor-pointer"
                                title={__('Click here to send us feedback or file an issue')} aria-label={__('Click here to send us feedback or file an issue')}>
                                <LuMessageSquareWarning />  {__('Contact Us')}
                            </Button>
                        </div>
                    ...
                    <ul className="list-none">
                        <li>
                            <Link color='gray' underline="always" size='2' target="_blank"
                                ...
                                href="https://github.com/The-Commit-Company/raven">{__('GitHub')} <FiExternalLink size='12' />
                            </Link>
                        </li>
                        <li>
                            <Link color='gray' underline="always" size='2' target="_blank"
                                title="https://community.ravenapp.cloud"
                                href="https://community.ravenapp.cloud">{__('Community')} <FiExternalLink size='12' />
                            </Link>
                        </li>
                        <li>
                            <Link color='gray' underline="always" size='2' target="_blank"
                                title="https://ravenchat.ai"
                                href="https://ravenchat.ai">{__('Website')} <FiExternalLink size='12' />
                            </Link>
                        </li>
                        <li>
                            <Link underline="always" size='2' target="_blank"
                                ...
                                href="mailto:support@thecommit.company">{__('Support Email')}
                            </Link>
                        </li>
                    </ul>
                    ...
                    <Stack gap='0'>
                        ...
                        <Text size='2' color='gray'>{__('Crafted by The Commit Company')}</Text>
                    </Stack>
                </Stack>
