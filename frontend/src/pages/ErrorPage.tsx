    ...
    return (
        <Flex className='h-screen w-screen bg-gray-2' align='center' justify='center'>
            <Stack gap='4'>
                ...
                <Text>{__('If you face this error again, please report it either on ')}<Link target='_blank' href='https://github.com/The-Commit-Company/raven/issues'>GitHub</Link>{__(' or ')}<Link target='_blank' href='https://support.ravenchat.ai/'>{__('our support portal')}</Link>.</Text>
